...
// --- Handle new sale submission (Same logic as v1 but adapted for v2) ---
...
<nav>
    ...
    <a href="new_sale_v2.php" class="active">New Sale</a>
    <a href="reports.php">Reports</a>
    <a href="low_stock.php">Low Stock</a>
</nav>

<div class="container">
    <h2>New Sale <span style="font-weight: 400; color: #64748b; font-size: 16px;">(Optimized V2)</span></h2>
